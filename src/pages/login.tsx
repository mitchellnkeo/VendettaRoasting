...
export default function Login() {
  ...
  if (success) {
    return (
      <>
        <Head>
          <title>Login Successful | Vendetta Roasting</title>
        </Head>
            ...
            <div className="max-w-md mx-auto text-center">
              <div className="bg-green-50 border border-green-200 rounded-lg p-6">
                ...
                <p className="text-green-700 mb-6">
                  You have successfully logged in. Welcome to Vendetta Roasting!
                </p>
                <Link 
                  href="/"
  ...
  return (
    <>
      <Head>
        <title>Sign In | Vendetta Roasting</title>
        <meta name="description" content="Sign in to your Vendetta Roasting account" />
      </Head>
          ...
          <div className="max-w-md mx-auto">
            ...
            <div className="text-center mt-6">
              <p className="text-coffee">
                ...
                <Link href="/register" className="text-coffee hover:text-coffee-light font-medium">
                  Create one here
                </Link>
              </p>
            </div>
